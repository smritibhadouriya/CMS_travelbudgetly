...
import { getPackages } from '@/client-api/api';
  ...
  if (!pkg) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 gap-3">
        ...
        <button onClick={() => router.push("/packages")} className="px-4 py-2 bg-indigo-600 text-white rounded-xl text-sm font-semibold">← Back to list</button>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-3 bg-white border-b border-gray-200 shadow-sm">
        ...
        <button onClick={() => router.push(`/packages/edit/${pkg.id}`)}
