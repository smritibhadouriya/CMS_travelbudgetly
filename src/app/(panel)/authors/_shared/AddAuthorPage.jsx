...
import { createAuthor, updateAuthor, getAuthor } from "@/client-api/api";
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-3 bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          <button type="button" onClick={() => router.push("/authors")} className="text-gray-400 hover:text-gray-600 text-sm">
            ← Back
          </button>
